...
require('lazy').setup({
  ...
  {
   'junegunn/fzf.vim', build = "./install --all"
  },
  {
    "ibhagwan/fzf-lua",
...
end, { desc = '[/] Fuzzily fearch in current buffer' })
...
--})
-- FzfLua shortcuts
vim.keymap.set("n", "<leader>lf", require('fzf-lua').files, { silent = true })
vim.keymap.set("n", "<leader>gs", require('fzf-lua').git_status, { silent = true })
vim.keymap.set("n", "<leader>rg", require('fzf-lua').grep, { silent = true })
...
--  Feel free to add/rems that you want here. They will automatically be installed.
